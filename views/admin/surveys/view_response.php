            ...
            <div class="card-body space-y-4">
                <?php foreach ($section['questions'] as $q): ?>
                    <div>
                        ...
                        <p class="<?= $q['type'] === 'rating' ? 'text-2xl leading-none text-amber-500 mt-0.5 whitespace-pre-line' : 'text-sm text-ink-600 mt-0.5 whitespace-pre-line' ?>"><?= nl2br(e($formatAnswer($q))) ?></p>
                    </div>
                <?php endforeach; ?>
